...
const char *ssid = "Apto402";
const char *password = "makairaapartamento402";
const char *mqtt_server = "206.189.202.242";

WiFiClient espClient;
PubSubClient client(espClient);
long lastMsg = 0;
int value = 0;
unsigned int plenght = 430;
...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    // Attempt to connect
    if (client.connect(clientId.c_str(), "smava", "12345678")) {
